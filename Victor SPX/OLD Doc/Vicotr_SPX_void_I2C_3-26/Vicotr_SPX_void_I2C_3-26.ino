...
//-------------------------------declare------------------------------------
  ...
  int value_of_controller_voidRE_to_voidmotor ;
...
//------------------------------motor_void----------------------------------------------
  void motor (int SPXpower, float nowSpeed, float maxSpeed, bool brake){
     ...
     //make sure value don't raise sharply by accident & Let value be above 93
        if ((SPXpower-LSPXpower)>=40||SPXpower<93) err=1;
...
//------------------------------setup----------------------------------------------
  void setup() {
    ...
    int changedValueFromController = map(valueFromController,194,800,93,145);
...
//-----------------------------I2C----------------------------------------------
  void receiveEvent(int bytes) {
    value_of_controller_voidRE_to_voidmotor = Wire.read();    // read one character from the I2C
  }
...
//------------------------------loop----------------------------------------------
 ...
 // get value from computer
    ...
    //get value from analog[Speed,controller]
      ...
      //get value from I2C
         int changedValueFromController=value_of_controller_voidRE_to_voidmotor;
      ...
      //get value for brake   [cotrollet brake]
