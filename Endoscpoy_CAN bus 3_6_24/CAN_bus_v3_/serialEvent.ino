void serialEvent(){
  ...
  if (inC == 'a')
    ...
    make_array_indentical(setVelocity_Directommand, velocity_normalSpeed);
    setVelocity_Direct(0);
    setVelocity_Direct(1);
    setVelocity_Direct(2);
  }
  else if (inC == 'F'){
...
//      changePosition_Direct_WaitUnitl(1, setPosition_rear_close);
//      changePosition_Direct_WaitUnitl(0, setPosition_front_open);
//      changePosition_Relative_Direct_WaitUntil(2, -a);
    }
    ...
    setVelocity_Directommand[4] = inI2;
    setVelocity_Directommand[5] = inI;
    setVelocity_Directommand[6] = 0;
    setVelocity_Directommand[7] = 0;
    ...
    Serial.println("\n ------ Testing ------ \n");
    changePosition_Relative_Direct_WaitUntil(0, -1201);
    Serial.println("\n ------- Done ---------\n");
  }
  else if (inC == 'W'){
    Serial.println("\n ------ auto cal motor 2 ------ \n");
    ...
    long2array(motor_a_pos[1], setPosition_rear_open);
