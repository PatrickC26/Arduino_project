...
unsigned char setPosition_command[8] = {0x23, 0x7A, 0x60, 0x00, 0x10, 0x17, 0x00, 0x00};
// 581 60  7A  60  0 0 0 0 0
const unsigned char setPosition_reply_OK_command[4] = {0x60, 0x7A, 0x60, 0x0};

// Check
unsigned char setVelocity_command[8] = {0x23, 0x7F, 0x60, 0x00, 0x10, 0x07, 0x00, 0x00};
// 60 7F  60  0 0 0 0 0
