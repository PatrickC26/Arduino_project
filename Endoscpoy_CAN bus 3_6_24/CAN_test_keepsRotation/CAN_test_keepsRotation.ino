...
unsigned char setPosition_front_open[8] = {0x23, 0x7A, 0x60, 0x00, 0x0, 0x0, 0x0, 0x0};
unsigned char setPosition_front_close[8] = {0x23, 0x7A, 0x60, 0x00, 0x01, 0x7, 0x0, 0x0};
unsigned char setPosition_0[8] = {0x23, 0x7A, 0x60, 0x00, 0x0, 0x0, 0x0, 0x0};
unsigned char setPosition[8] = {0x23, 0x7A, 0x60, 0x00, 0x30, 0xF8, 0xFF, 0xFF};
//unsigned char setPosition[8] = {0x23, 0x7A, 0x60, 0x00, 0x00, 0x36, 0x0, 0x0};
...
//    Serial.println
    ...
    CAN.sendMsgBuf(id, 0, 8, setPosition_front_open);
    delay(5);
    checkResponse_reply();
    ...
    for (int i = 0 ; i < 0 ; i++){
      ...
      Serial.println("setposition_0_command");
      CAN.sendMsgBuf(id, 0, 8, setPosition_front_close);
      delay(5);
      checkResponse_reply();
