...
long motor_final_position[3] = {0,0,0};
...
int motor_max_distance[3] = {1552,3104,0xA49};
...
byte marginDetectStatus[3] = {0,0,0};
byte marginDetectStatus_pre[3] = {0,0,0};
const byte within_a_side = 1;
const byte within_b_side = 2;
const byte within_a_b = 3;
